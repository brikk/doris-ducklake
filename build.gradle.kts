...
repositories {
    ...
    // publish->consume smoke loop (before the snapshot/release is on Central). Released
    // versions resolve from mavenCentral; -SNAPSHOTs from the Central Portal snapshots repo
...
dependencies {
    ...
    // published as the -test-fixtures variant of dev.brikk.ducklake:ducklake-catalog.
